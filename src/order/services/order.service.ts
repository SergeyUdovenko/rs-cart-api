...
import { Order as OrderProps } from '../models';
...
export class OrderService {
  ...
  async findById(orderId: string): Promise<OrderProps> {
    return await this.orderRepository.findOne(orderId);
  }

  async create(data: any): Promise<OrderProps> {
  ...
  async update(orderId, data): Promise<OrderProps> {
